...
/*  static map<WorldObjectType, Point2D> beacon_locs = {
    ...
    static map<WorldObjectType, Point2D> beacon_locs = {
        { WO_BEACON_BLUE_YELLOW,    Point2D(1000, 1000) },
        { WO_BEACON_YELLOW_BLUE,    Point2D(1000, 1000) },
        { WO_BEACON_BLUE_PINK,      Point2D(0, -1000) },
        { WO_BEACON_PINK_BLUE,      Point2D(0, -1000) },
        { WO_BEACON_PINK_YELLOW,    Point2D(-1000, 1000) },
        { WO_BEACON_YELLOW_PINK,    Point2D(-1000, 1000) }
    };
